...
public class Verbas {
		...
		public TipoVerbaRemuneratoriaT getTipoVerbaRemuneratoriaT() {
			...
			tipoVerbaRemuneratoria.setCodigoTipoVerbaRemuneratoria(this.tipoVerbaRemuneratoria.getCodigoTipoVerbaRemuneratoria());
			return tipoVerbaRemuneratoria;
		}
		...
		public void setQuantidadeHorasExtras(String quantidadeHorasExtras) {
			this.quantidadeHorasExtras = new BigDecimal(quantidadeHorasExtras);
		}
